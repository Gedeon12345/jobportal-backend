...
// @deesc   Get logged-in user's applications
...
// @deesc   Get all applicants for a job (Employer)
...
// @deesc   Get application by ID (jobseeker or Employer)
exports.getApplicationById = async (req, res) => {
    try {
        ...
        if (!app) return res.status(404).json({ message: "Applicant not found.", id: req.params.id });
...
// @deesc   Update application status (jobseeker or Employer)
